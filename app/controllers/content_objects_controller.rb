class ContentObjectsController < ApplicationController
  ...
  def show
    ...
    if @response.has_key?('code')
      ...
      @associated_object_ids = @object.associated_objects
      ...
      # single SES lookup for object + associations
      assoc_ses_ids = @associated_objects.flat_map(&:ses_lookup_ids)
      @ses_data = SesLookup.new(@object.ses_lookup_ids + assoc_ses_ids).data
