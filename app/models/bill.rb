class Bill < ContentTypeObject
  ...
  def self.search_result_solr_fields
    ...
    super << %w[title_t uri member_ses memberParty_ses department_ses department_t
      corporateAuthor_ses corporateAuthor_t legislationTitle_ses
      legislationTitle_t witness_ses witness_t subject_ses subject_t searcherNote_t
