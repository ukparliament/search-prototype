  ...
  describe 'self.generate' do
    ...
    context 'when passed a known object type' do
      ...
      it 'returns an instance of the type class' do
        ...
        expect(ContentObject.generate(parliamentary_proceeding_grand_committee)).to be_an_instance_of(ParliamentaryProceeding)
        expect(ContentObject.generate(parliamentary_proceeding_committee)).to be_an_instance_of(ParliamentaryProceeding)
