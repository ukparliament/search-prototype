  ...
  describe 'self.generate' do
    ...
    context 'when passed a known object type' do
      ...
      it 'returns an instance of the type class' do
        ...
        expect(ContentObject.generate(parliamentary_paper_laid)).to be_an_instance_of(UnprintedPaper)
        ...
        expect(ContentObject.generate(parliamentary_paper_laid_command_paper)).to be_an_instance_of(CommandPaper)
        expect(ContentObject.generate(parliamentary_paper_laid_unprinted_command_paper)).to be_an_instance_of(UnprintedCommandPaper)
        expect(ContentObject.generate(parliamentary_paper_laid_house_of_commons_paper)).to be_an_instance_of(HouseOfCommonsPaper)
        expect(ContentObject.generate(parliamentary_paper_laid_house_of_lords_paper)).to be_an_instance_of(ParliamentaryPaperLaid)
        expect(ContentObject.generate(parliamentary_paper_laid_unprinted_paper)).to be_an_instance_of(UnprintedPaper)
