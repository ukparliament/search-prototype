...
RSpec.describe EPetition, type: :model do
  ...
  describe 'object_name' do
    it 'returns object type' do
      allow(e_petition).to receive(:type).and_return({ value: 12345, field_name: 'type_ses' })
      expect(e_petition.object_name).to eq({ value: 12345, field_name: 'type_ses' })
    end
  end
  ...
  describe 'reference' do
    ...
    context 'where data exists' do
      ...
      it 'returns the first item' do
        expect(e_petition.reference).to eq({:field_name=>"identifier_t", :value=>"first item"})
      end
    end
  end
  ...
  describe 'subjects' do
    ...
    context 'where data exists' do
      ...
      it 'returns all items as an array' do
        expect(e_petition.subjects).to eq([{:field_name=>"subject_ses", :value=>"first item"}, {:field_name=>"subject_ses", :value=>"second item"}])
      end
    end
  end
  ...
  describe 'legislation' do
    ...
    context 'where data exists' do
      ...
      it 'returns all items as an array' do
        expect(e_petition.legislation).to eq([{:field_name=>"legislationTitle_ses", :value=>12345}, {:field_name=>"legislationTitle_ses", :value=>67890}])
      end
    end
  end
end