  ...
  describe 'prelim_template' do
    context 'when state is tabled' do
      it 'returns the tabled partial' do
        ...
        expect(oral_question.prelim_template).to eq('/content_type_objects/preliminary_sentences/oral_question_tabled')
      end
    end
    context 'when state is withdrawn' do
      it 'returns the withdrawn partial' do
        ...
        expect(oral_question.prelim_template).to eq('/content_type_objects/preliminary_sentences/oral_question_withdrawn')
      end
    end
    context 'when state is answered' do
      it 'returns the answered partial' do
        ...
        expect(oral_question.prelim_template).to eq('/content_type_objects/preliminary_sentences/oral_question_answered')
      end
    end
